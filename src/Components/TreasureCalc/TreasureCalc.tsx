...
export default function BasicTextFields() {
    ...
    const handleClick = () => {
        ...
        let items = calculateItems(experiencePoints);
    ...
    return (
        ...
        >
            ...
            {isDescriptionVisible && <p id='description'>על מנת לקבוע באופן אקראי את האוצר של מפלצת כלשהי יש ראשית להכפיל את ערך הנק"ן שלה ב1ק3 + 1. זה סך ערך האוצר במטבעות זהב. אין פירוש הדבר כי כל האוצר כולו הוא במטבעות זהב, ערך זה ישמש אותך כבסיס לקביעת תוכן האוצר עצמו.
            ...
            {!isDescriptionVisible && <TreasureTable />}
